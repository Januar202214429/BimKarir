<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
            <section class="p-4 bg-white shadow-sm sm:p-8 sm:rounded-lg">
                    ...
                    <tbody>
                        @foreach ($jadwalPeriksas as $jadwalPeriksa)
                            <tr>
                                ...
                                <td class="align-middle text-start">
                                    <form 
                                        action="{{ route('dokter.jadwal-periksa.update', $jadwalPeriksa->id) }}" 
                                        method="POST"
                                    >
                                        @csrf
                                        @method('PATCH')
