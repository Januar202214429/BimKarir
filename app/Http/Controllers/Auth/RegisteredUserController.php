...
$existingPatient = User::where('no_ktp',
$request->no_ktp)->first();
if ($existingPatient) {
...
$patientCount = User::where('no_rm', 'like',
$currentYearMonth . '-%')->count();
// Buat no_rm dengan format tahun-bulan-urutan
$no_rm = $currentYearMonth . '-' . str_pad($patientCount
+ 1, 3, '0', STR_PAD_LEFT);
